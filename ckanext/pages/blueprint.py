...
pages.add_url_rule(
    "/pages/<page>/revisions/<revision>", view_func=pages_revisions_preview
)
pages.add_url_rule(
    "/pages/<page>/revisions/<revision>/restore",
    view_func=pages_revision_restore,
    methods=["GET"],
)
pages.add_url_rule(
    "/pages_edit", view_func=pages_edit, endpoint="new", methods=["GET", "POST"]
)
pages.add_url_rule(
    "/pages_edit/", view_func=pages_edit, endpoint="new", methods=["GET", "POST"]
)
pages.add_url_rule(
    "/pages_edit/<page>", view_func=pages_edit, endpoint="edit", methods=["GET", "POST"]
)
pages.add_url_rule(
    "/pages_delete/<page>",
    view_func=pages_delete,
    endpoint="delete",
    methods=["GET", "POST"],
)
...
pages.add_url_rule(
    "/blog/<page>/revisions/<revision>", view_func=blog_revisions_preview
)
pages.add_url_rule(
    "/blog/<page>/revisions/<revision>/restore",
    view_func=blog_revision_restore,
    methods=["GET"],
)
pages.add_url_rule(
    "/blog_edit", view_func=blog_edit, endpoint="blog_new", methods=["GET", "POST"]
)
pages.add_url_rule(
    "/blog_edit/", view_func=blog_edit, endpoint="blog_new", methods=["GET", "POST"]
)
...
pages.add_url_rule(
    "/organization/pages/<id>", view_func=org_show, endpoint="organization_pages_index"
)
pages.add_url_rule(
    "/organization/pages/<id>/<page>",
    view_func=org_show,
    endpoint="organization_pages_show",
)
pages.add_url_rule(
    "/organization/pages_edit/<id>",
    view_func=org_edit,
    endpoint="organization_pages_new",
    methods=["GET", "POST"],
)
pages.add_url_rule(
    "/organization/pages_edit/<id>/",
...
pages.add_url_rule(
    ...
    view_func=org_edit,
    endpoint="organization_pages_edit",
    methods=["GET", "POST"],
)
pages.add_url_rule(
    "/organization/pages_delete/<id>/<page>",
    view_func=org_delete,
    endpoint="organization_pages_delete",
    methods=["GET", "POST"],
)

pages.add_url_rule(
    "/group/pages/<id>", view_func=group_show, endpoint="group_pages_index"
)
pages.add_url_rule(
    "/group/pages/<id>/<page>", view_func=group_show, endpoint="group_pages_show"
)
pages.add_url_rule(
    "/group/pages_edit/<id>",
    view_func=group_edit,
    endpoint="group_pages_new",
    methods=["GET", "POST"],
)
pages.add_url_rule(
    "/group/pages_edit/<id>/",
...
pages.add_url_rule(
    ...
    view_func=group_edit,
    endpoint="group_pages_edit",
    methods=["GET", "POST"],
)
pages.add_url_rule(
    "/group/pages_delete/<id>/<page>",
    view_func=group_delete,
    endpoint="group_pages_delete",
    methods=["GET", "POST"],
)
